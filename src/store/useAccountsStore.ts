...
type FinancialAccountsState = {
  ...
  updateAccount: (accountId: string, data: Partial<FinancialAccount>) => Promise<void>;
...
export const useFinancialAccountsStore = create<FinancialAccountsState>((set, get) => ({
  ...
  fetchAccounts: async () => {
    ...
    try {
      ...
      const accountsRef = collection(db, 'clients', clientId, 'condominiums', condominiumId, 'financialAccounts');
  ...
  updateAccount: async (accountId: string, data: Partial<FinancialAccount>) => {
    ...
    try {
      ...
      const db = getFirestore();
      const accountDoc = doc(db, 'clients', clientId, 'condominiums', condominiumId, 'financialAccounts', accountId);
