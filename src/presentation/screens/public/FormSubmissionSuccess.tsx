...
const FormSubmissionSuccess: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Formulario Enviado | EstateAdmin</title>
        <meta
          name="description"
          content="Confirmación de envío del formulario de información."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href="https://estate-admin.com/formulario-completado" />
      </Helmet>
