        ...
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 min-w-[320px] relative">
            ...
            <div className="mb-2 text-sm">
              Selecciona el ticket principal (conservará los datos principales):
            </div>
            ...
            {mergeError && (
              <div className="text-red-500 text-xs mb-2">{mergeError}</div>
            )}
                ...
                <div className="flex items-start">
                  ...
                  >
                    <div className="flex items-center justify-between mb-1.5">
                      <h4 className="font-medium text-gray-900 dark:text-gray-100 text-sm truncate pr-2">
                        {ticket.title}
                      </h4>
                      ...
                      {Array.isArray(ticket.tags) && ticket.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          {ticket.tags.map((tag, idx) => (
                            <span
                              key={idx}
                              className="px-2 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs font-medium"
                            >
                              {tag}
                            </span>
                          ))}
