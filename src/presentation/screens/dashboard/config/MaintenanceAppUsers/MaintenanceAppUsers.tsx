        ...
        <div>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <span className="font-semibold text-emerald-600 dark:text-emerald-400">
              App Móvil de Mantenimiento
            </span>
            . Pueden gestionar tickets, inventario y reportes desde su
            dispositivo.
          </p>
        </div>
        {!showForm && (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1">
                        {user.assignedCondominiums.map((condoId) => (
                          <span
                            key={condoId}
                            className="inline-flex text-center items-center px-2 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200"
                          >
