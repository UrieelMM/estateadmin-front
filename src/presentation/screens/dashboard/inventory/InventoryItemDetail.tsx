          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p
                  className={ `text-xl font-bold ${ selectedItem.stock <= selectedItem.minStock
                      ? "text-red-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              { selectedItem.brand && (
                <div>
                  ...
                  <p className="text-gray-800 dark:text-white">{ selectedItem.brand }</p>
                </div>
              ) }
              ...
              { selectedItem.model && (
                <div>
                  ...
                  <p className="text-gray-800 dark:text-white">{ selectedItem.model }</p>
                </div>
              ) }
              ...
              { selectedItem.serialNumber && (
                <div>
                  ...
                  <p className="text-gray-800 dark:text-white">{ selectedItem.serialNumber }</p>
                </div>
              ) }
            </div>
            ...
            { selectedItem.notes && (
              <div className="mt-6">
                ...
                <p className="text-gray-800 dark:text-white">{ selectedItem.notes }</p>
              </div>
            ) }
          </div>
            ...
            { loadingMovements ? (
              ...
              <div className="space-y-4">
                { movements.slice( 0, 5 ).map( ( movement ) => (
                  <div key={ movement.id } className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white text-sm font-medium rounded-lg px-3 py-2 inline-flex items-center justify-center"
              >
                <i
                  className={ `fas ${ selectedItem.status === ItemStatus.ACTIVE
                      ? "fa-ban text-red-500"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            { selectedItem.supplier && (
              <div className="mb-4">
                ...
                <p className="text-gray-800 dark:text-white">{ selectedItem.supplier }</p>
              </div>
            ) }
          </div>
        </div>
