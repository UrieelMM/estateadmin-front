...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="dark:bg-gray-800 p-4 rounded-lg shadow-md mb-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-3 lg:space-y-0 lg:space-x-4">
        ...
        <div className="lg:w-1/3">
          <div className="relative">
            ...
            <input
              ...
              className="border-gray-200 dark:bg-gray-700 border dark:border-gray-600 text-gray-500 dark:text-gray-100 text-sm rounded-lg block w-full ps-2 p-2.5 placeholder-gray-400"
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-2 lg:gap-4">
          <select
            ...
            className="bodrder-gray-100 text-gray-800 dark:bg-gray-700 border dark:border-gray-600 dark:text-gray-100 text-sm rounded-lg p-2.5"
          >
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4 border-gray-200 dark:bg-gray-700 dar:border-gray-600 rounded focus:ring-blue-500"
            />
            <label
          ...
          <button
            ...
            className=" text-gray-800 border-gray-200 ring-1 ring-gray-200 dark:text-gray-100 dark:bg-gray-700 dar:hover:bg-gray-600 focus:ring-4 dark:focus:ring-gray-500 font-medium rounded-lg text-sm px-4 py-2"
          >
