  ...
  return (
    <div className="p-6">
      <div className="mb-6 text-center">
        <div className="inline-flex justify-center items-center w-16 h-16 rounded-full bg-gray-700 mb-4">
          <i
            className={`fas ${icons[operation]} text-2xl ${
              operation === "add" ? "text-green-500" : "text-yellow-500"
            }`}
          ></i>
        </div>
        ...
        <div className="font-bold text-lg text-white mt-2">{item.name}</div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            } text-white sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
        ...
        <div className="flex justify-end space-x-3 pt-4">
          <button
            type="button"
            onClick={onCancel}
            className="px-4 py-2 bg-gray-700 text-white text-sm font-medium rounded-lg hover:bg-gray-600"
            disabled={loading}
          >
            Cancelar
          </button>
