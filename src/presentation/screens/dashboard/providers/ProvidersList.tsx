...
import FormProvider from '../../../components/shared/forms/ProviderForm'
...
const ProviderList = () => {
  ...
  return (
    ...
    <header className="bg-gray-100 shadow-md flex w-full h-16 justify-between px-2 rounded-md items-center mb-2">
        <p className="tex-md font-bold">Proveedores</p>
        <button className="btn-primary h-10 mb-3" onClick={onClose}>Agregar proveedor</button>
      </header>
    ...
    <FormProvider isOpen={isOpen} onClose={onClose} />
    </>
  )
}
