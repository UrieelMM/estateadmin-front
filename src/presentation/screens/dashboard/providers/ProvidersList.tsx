        ...
        {people.map((person) => (
          ...
          >
            <div className="flex flex-1 flex-col p-8 dark:bg-gray-800">
              ...
              <h3 className="mt-6 text-sm font-medium text-gray-900 dark:text-gray-100">{person.name}</h3>
              <dl className="mt-1 flex flex-grow flex-col justify-between">
                <dt className="sr-only">Title</dt>
                <dd className="text-sm text-gray-500 dark:text-gray-100">{person.telephone}</dd>
              ...
              <div className="-mt-px flex divide-x divide-gray-200 dark:divide-gray-500">
                <div className="flex w-0 flex-1">
                  <a
                    ...
                    className="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900 bg-gray-900 dark:text-gray-100"
                  >
                ...
                <div className="-ml-px flex w-0 flex-1">
                  <a
                    ...
                    className="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900 bg-gray-900 dark:text-gray-100"
                  >
