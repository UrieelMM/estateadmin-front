...
import { ProjectCreateInput, ProjectStatus, useProjectStore } from '../../../../store/projectStore';
...
const NewProjectModal: React.FC<NewProjectModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (endDate < startDate) {
      toast.error('La fecha de entrega no puede ser anterior a la fecha de inicio');
      return;
    }
