...
const PrivacyPolicy = () => {
  ...
  const pageUrl = "https://estate-admin.com/privacidad";
  const pageTitle = "Política de Privacidad | EstateAdmin";
  const pageDescription =
    "Consulta la política de privacidad de EstateAdmin para administración de condominios, tratamiento de datos personales y derechos del usuario.";
  const pageKeywords =
    "politica de privacidad estateadmin, privacidad condominios, tratamiento de datos personales, software administracion de condominios";
