  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 overflow-y-auto">
        ...
        <motion.div key="s8" variants={wrap} initial="hidden" animate={isActive ? "visible" : "hidden"} className="grid grid-cols-1 lg:grid-cols-5 gap-5 lg:gap-8 items-start">
          {/* Left */}
          <div className="lg:col-span-2 flex flex-col gap-5">
            <motion.div variants={hdr}>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
                ...
                <br />
                <span className="text-slate-300 text-lg sm:text-xl lg:text-2xl font-semibold">inteligente con QR</span>
              </h2>
