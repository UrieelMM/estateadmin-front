...
const NotFoundPage = () => {
  // Extraer el path actual para usarlo en el título
  ...
  return (
    <div className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center h-screen flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16 bg-indigo-100 dark:bg-gray-900">
      <Helmet>
        <title>Página no encontrada - {currentPath} | EstateAdmin</title>
        ...
        <div>
          <div>
            <div className="">
              <h1 className="my-2 text-gray-800 font-bold text-2xl dark:text-gray-100">
                ¡Oops! 404: Este contenido debe haberse perdido en una línea
                temporal diferente.
              </h1>
              <p className="text-md my-4 text-gray-600 dark:text-gray-100">
          ...
          <div className="w-auto h-96">
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/administracioncondominio-93419.appspot.com/o/estateAdminUploads%2Fassets%2F404ErrorPageEstateAdmin.svg?alt=media&token=b9a82a09-f184-46c3-9bff-e8265c8f575e"
              alt="Error page 404"
            />
          </div>
        </div>
