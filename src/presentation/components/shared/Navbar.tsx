            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              >
                <div className="relative w-5 h-5">
                  {/* Sol icon */ }
                  <SunIcon
                    className={ `absolute inset-0 w-5 h-5 text-yellow-400 transition-all duration-500 transform ${ !isDarkMode
                  ...
                  {/* Luna icon */ }
                  <MoonIcon
                    className={ `absolute inset-0 w-5 h-5 text-indigo-200 transition-all duration-500 transform ${ isDarkMode
                        ? "opacity-100 rotate-0 scale-100"
                        : "opacity-0 -rotate-180 scale-75"
                      }` }
                  />
